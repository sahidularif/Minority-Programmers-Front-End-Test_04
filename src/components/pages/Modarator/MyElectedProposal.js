...
import heroImage from '../../../images/elected-proposal-hero.png'
    ...
    return (
        <div className="container-fluid body-bg g-0">
            ...
            <div className="row justify-content-center">
                <div className="col-md-11 p-5 justify-content-center elected-proposal-container">


                    {/* Not Elected */}
                    {
                        tasks.map((task, index) =>
                            <div className="row justify-content-center unselected-task" key={index}>
                                <div className="col-md-12 proposal-box mb-5">
                                    <div className="row justify-content-center">
                                        <div className="col-md-12 justify-content-center m-3">
                                            <div className="row justify-content-center align-items-center mt-3">
                                                <div className="col-md-6">
                                                    <div className="proposl-title-category">
                                                        <h5><i class="far fa-check-circle" />{task.title}</h5>
                                                        <span><strong>Type:</strong> {task.type} <strong>Category: </strong>{task.category}</span>
                                                    </div>
                                                    <div className="row">
                                                        <div className="col-md-12">
                                                            <div className="proposal-progress-bar">
                                                                <div className="proposal-percent">
                                                                    <p className="proposal-bar-parcent" style={{ width: `${task.completedStatus}%` }}></p>
                                                                </div>
                                                    ...
                                                    <div className="row justify-content-center align-items-center text-center">
                                                        ...
                                                        <div className="col-md-6 d-flex justify-content-center align-items-center">
                                                            ...
                                                            <div className="proposal-votes">
                                                                ...
                                                                <span className="vote-count-num">{task.totalVotes}</span>
