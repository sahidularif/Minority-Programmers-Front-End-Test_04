                    ...
                    <div className="col-md-11 elect-proposal-box justify-content-center align-items-center">
                        <div className="proposal-notification-title">
                            ...
                            <div className="days-to-left">
                                <h3>{availblDayToLeft} days left to vote</h3>
                            </div>
                        </div>
                        ...
                        <div className="proposal-user-details">
                            ...
                            <div className="proposal-details-btn">
                                <button type="button" className="btn-proposal-approve">Approve</button>
                                <button type="button" className="btn-proposal-disapprove">Disapprove</button>
                            </div>
                        </div>
                        <div className="row proposal-text-btn">
                            ...
                            <div className="col-md-3 proposal-btn">
                                <button type="button" className="ct-notification-btn">View Proposal</button>
                            </div>
                        </div>
                    </div>
                </div>
